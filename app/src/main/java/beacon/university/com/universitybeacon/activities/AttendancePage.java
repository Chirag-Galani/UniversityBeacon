    ...
    public void markAttendanceButtonClick(final View v) {
        final ServerCallback isClassStartedServerCallback = new ServerCallback() {
            ...
            public void onSuccess(String result) {
                ...
                Boolean value = Boolean.parseBoolean(result);
                if (value)
                    Toasty.success(AttendancePage.this, "Class has been initiated for attendance", Toast.LENGTH_LONG,true).show();
                else
                    Toasty.error(AttendancePage.this, "Oops! Class has already been initiated for attendance", Toast.LENGTH_LONG,true).show();
            }
        };
        final ServerCallback attendanceMarkCallback = new ServerCallback() {
            ...
            public void onSuccess(String result) {
                ...
                Boolean value = Boolean.parseBoolean(result);
                if (value)
                    Toasty.success(AttendancePage.this, "Your attendance has been marked", Toast.LENGTH_LONG,true).show();
                else
                    Toasty.error(AttendancePage.this, "Oops! Your attendance has already been marked.", Toast.LENGTH_LONG,true).show();
            }
        };
        final ServerCallback isStudentCallback = new ServerCallback() {
            ...
            public void onSuccess(String result) {
                ...
                if (value) {
                    ...
                    Toasty.error(AttendancePage.this, "You are not registered for this course. Please contact administrator", Toast.LENGTH_LONG,true).show();
                }
            }
        };
